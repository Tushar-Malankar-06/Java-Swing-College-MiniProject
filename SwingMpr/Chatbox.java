...
{
	JLabel label_hello, label_greeting, label_greeting2;
	JLabel[] label_chat= new JLabel[20];
	JLabel[]  temp;
	String s=" ";
	String a=" ";
	boolean bool=true;
...
//	ScrollPane scrollB1, scrollB2;
	...
	label_chat[index_pos] = new JLabel(arg, SwingConstants.RIGHT);
	...
	label_chat[index_pos] = new JLabel(arg, SwingConstants.LEFT);
	label_chat[index_pos].setFont(new Font("Times New Roman",Font.BOLD,16));
	...
	{	
		...
		label_hello = new JLabel("Newark Helpdesk", SwingConstants.CENTER);
		label_hello.setFont(new Font("Times New Roman",Font.BOLD,19));
		...
		label_hello.setOpaque(true);
		this.add(label_hello);
		
		//label_hello.revalidate();
		
		//Add Username from database in the String
		String S = new String("Customer");
		...
		User_Textfield.setBounds(10,620,550,25);
		this.add(User_Textfield);
		User_Textfield.setOpaque(true);
		User_Textfield.setVisible(true);

		b=new JButton("Send");
		b.setForeground(Color.WHITE);
		b.setBackground(new Color(34,139,34));
		b.setFont(new Font("Serif",Font.BOLD|Font.ITALIC,20));
		b.setBounds(570,620,110,25);
